...
* **⊗** (an optional column for the student selection checkboxes)
	* Click on this column header (or the **More** button) to open a menu with possible actions. 
		* Please note that most actions are available only when at least one checkbox in this column is checked for some student. I.e., there is at least one student for whom the action can be called.
	* **Select All**
...
* **Student**
	* Name of the student
* **Campus**
	* Campus of the student (when used)
* **Area**
