...
![Student Scheduling Assistant](images/scheduling-assistant-6.png){:class='screenshot'}
...
![Student Scheduling Assistant](images/scheduling-assistant-8.png){:class='screenshot'}

**Note 3:** The checkboxes next to the instructional methods (when there are multiple) or individual sections can be used to provide preferences. When the **Selection Required** box is checked, only enrollments meeting the selected preferences can be returned.
...
![Student Scheduling Assistant](images/scheduling-assistant-10.png){:class='screenshot'}
...
![Student Scheduling Assistant](images/scheduling-assistant-12.png){:class='screenshot'}
...
![Student Scheduling Assistant](images/scheduling-assistant-15.png){:class='screenshot'}
...
Review the suggested schedule.  If you are happy with the schedule, press the **Submit Schedule** button. If all sections were successfully enrolled, you will see a **Success!** message, and each section will have a green checkmark ![checkmark](../images/icon-tick.png) listed next to it. Sections that failed the validation will show a red exclamation mark icon ![!](../images/icon-problem.png) next to them. Clicking the icon will also show the corresponding registration error.
...
![Student Scheduling Assistant](images/scheduling-assistant-18.png){:class='screenshot' style='width:50%;'}

It is also possible to lock a class on the **Time Grid** tab by clicking the lock icon ![lock](../images/icon-unlock.png).

![Student Scheduling Assistant](images/scheduling-assistant-19.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Assistant](images/scheduling-assistant-20.png){:class='screenshot' style='width:50%;'}

This will bring up the new course selection dialog.

![Student Scheduling Assistant](images/scheduling-assistant-21.png){:class='screenshot'}
...
![Student Scheduling Assistant](images/scheduling-assistant-22.png){:class='screenshot'}
...
![Student Scheduling Assistant](images/scheduling-assistant-23.png){:class='screenshot'}
...
![Student Scheduling Assistant](images/scheduling-assistant-30.png){:class='screenshot'}
...
![Student Scheduling Assistant](images/scheduling-assistant-31.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Assistant](images/scheduling-assistant-32.png){:class='screenshot' style='width:50%;'}
